...
const io = socketIo(server, {
  cors: {
    origin: "https://xo-game-git-main-khoinv02s-projects.vercel.app",
    methods: ["GET", "POST"],
    allowedHeaders: ["Content-Type", "Authorization"]
  }
});
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://xo-game-git-main-khoinv02s-projects.vercel.app');
